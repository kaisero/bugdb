"""Prisma Access crawler implementation."""
...
class PrismaAccessCrawler(BaseCrawler):
    """Crawler for Prisma Access (Cloud-managed) release notes."""

    product_id = "prisma-access"
    ...
    async def discover_versions(self) -> list[str]:
        ...
        Returns:
            List of major version strings (e.g., ["6-1", "5-2"]).
        """
        ...
        async def check_version(version: str) -> str | None:
            ...
            try:
                ...
                h1 = soup.find("h1")
                if h1:
                    logger.debug("Found valid Prisma Access version: %s", version)
                    return version
                return None
            except Exception:
                return None
    ...
    async def discover_version_pages(self, major_version: str) -> list[VersionInfo]:
        ...
        Args:
            major_version: The major version (e.g., "5-2").
